...
export const NEG_CATEGORIAS = ['Wholesaling', 'CAEP', 'Mediação Imobiliária', 'Fix and Flip', 'Consultoria/Assessoria']
...
export const MODELOS_NEGOCIO = ['Wholesaling', 'Fix and Flip', 'CAEP', 'Mediação Imobiliária', 'Consultoria/Assessoria']
