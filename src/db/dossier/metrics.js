...
export function computeMOIC(capital, lucroLiquido) {
...
export function computePayback({ meses, lucroLiquido }) {
...
export function formatMOIC(v) {
  if (v == null || !Number.isFinite(v)) return '—'
  return `${v.toFixed(2)}x`
}

export function formatPayback(meses) {
