...
/**
 * Devolve a ficha de visita (JSONB) da visita mais recente do imovel que tenha
 * ficha preenchida. Usado para pre-preencher o PDF ficha_visita.
 */
export async function getFichaVisitaParaImovel(imovelId) {
