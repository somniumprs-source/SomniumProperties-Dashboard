...
async function alertarConflitoSync(tarefaAntes: any, eventoNovo: any): Promise<void> {
  const linhas = [
  ...
  try {
    ...
    console.error("[gcal-sync] Erro ao enviar alerta de conflito:", (e as Error).message);
  }
}
