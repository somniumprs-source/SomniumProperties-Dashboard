 ...
 * Diferenças: logo via LOGO_BLACK_PNG (sem leitura de disco) e fotos via
 * buffers `_data` pré-carregados (preload por fetch nos handlers) em vez de
 * paths de disco — o `/public/uploads` não existe nos isolates.
 */
