 ...
 *
 * Port de src/db/pdfOrcamentoObra.js (Express -> Edge Functions / Deno).
 * Diferença: logo via LOGO_BLACK_PNG (sem leitura de disco — `/public` não
 * existe nos isolates) e PDFDocument vem do pdfkitGuard (sanea NaN/Infinity).
 */
