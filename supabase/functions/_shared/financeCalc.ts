...
export function despesasDaEmpresa(despesas: any[]) {
...
export function calcBurnRateMensal(despesas: any[]) {
...
export function calcDespesasAnuaisTotal(despesas: any[], { anoCorrente }: { anoCorrente?: number } = {}) {
  const gerais = despesasDaEmpresa(despesas);
