// Stub cron — "cron-relatorio-diario". Invocado por pg_cron via net.http_post; protegido por INTERNAL_API_KEY.
...
Deno.serve((req) => {
  ...
  return Response.json({ ok: true, ran: false, fn: "cron-relatorio-diario" });
});
