...
Perguntar ao utilizador que departamento esta envolvido. Depois ler `.claude/dept/[departamento].md` para contexto e tabela de ficheiros.

## Instrucoes

### Fase 1: Planear
1. Ler CLAUDE.md para perceber a arquitectura
2. Usar a tabela de ficheiros do departamento para identificar ficheiros a alterar
...
- Para corrigir bugs (usar /comercial/crm-audit)
