...
Perguntar ao utilizador que departamento esta envolvido. Depois ler `.claude/dept/[departamento].md` para contexto.
...
- Para corrigir bugs de logica (usar /comercial/crm-audit)
- Para alterar PDFs (usar /financeiro/pdf-upgrade)
